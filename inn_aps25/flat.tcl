...
setPlaceMode -place_global_timing_effort high -congEffort auto -timingDriven 0 -clkGateAware 1 -powerDriven 0 -ignoreScan 1 -reorderScan 1 -ignoreSpare 0 -placeIOPins 1 -moduleAwareSpare 0 -preserveRouting 1 -rmAffectedRouting 0 -checkRoute 0 -swapEEQ 0 
place_design
#place_opt_design 
...
checkNetlist > ${_PRECTS}/checkNetlist.txt
...
checkNetlist > ${_POSTCTS}/checkNetlist.txt
...
checkNetlist > ${_POSTROUTE}/checkNetlist.txt
