...
setDesignMode -powerEffort extreme
...
setPlaceMode  -congEffort auto -timingDriven 0 -clkGateAware 1 -powerDriven 1 -ignoreScan 1 -reorderScan 1 -ignoreSpare 0 -placeIOPins 1 -moduleAwareSpare 0 -preserveRouting 1 -rmAffectedRouting 0 -checkRoute 0 -swapEEQ 0 
place_design
optDesign -preCTS -incr
optPower -preCTS -allowresizing -effortLevel high -force
...
optPower -postCTS -allowresizing -effortLevel high -force
#optDesign -postCTS 
#optDesign -postCTS -incr
...
optPower -postRoute -allowresizing -effortLevel high -force
#route_opt_design 
